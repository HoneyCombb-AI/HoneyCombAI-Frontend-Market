      ...
      <main className="pt-24 pb-20">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-12">
          ...
          <div className="flex flex-col gap-12">
            {BLOG_POSTS.map((post) => (
              <Link key={post.slug} href={`/blog/${post.slug}`} className="group block max-w-5xl mx-auto w-full">
                <div className="relative w-full rounded-[2rem] overflow-hidden bg-[#0A0A0A] border border-gray-800 shadow-2xl transition-all duration-500 hover:shadow-[0_20px_50px_rgba(250,204,21,0.1)] hover:-translate-y-1">
                  <div className="p-8 md:p-16 flex flex-col items-center text-center">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-[1.1] tracking-tight group-hover:text-yellow-400 transition-colors max-w-4xl">
                      {post.title}
                    </h2>
                    
                    <p className="text-lg text-gray-400 mb-8 leading-relaxed max-w-2xl line-clamp-3">
                      {post.excerpt}
                    </p>
                    
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-yellow-400 flex items-center justify-center text-black font-bold text-base">
                          {post.author[0]}
                        </div>
                      ...
                      <div className="h-10 w-[1px] bg-gray-800 hidden md:block" />
                      
                      <div className="flex items-center text-yellow-400 font-bold text-base group-hover:translate-x-2 transition-transform">
                        Read Article
